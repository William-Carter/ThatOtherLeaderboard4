...
class Goldboard(interactions.Extension):
    ...
    async def goldboard(self, ctx: interactions.SlashContext, category: str, mapName: str = None, start: int = 1):
        ...
        if mapName:
            ...
            gb = UI.leaderboards.Leaderboard(["Runner", "Sum of Best"], golds, 1, start)
